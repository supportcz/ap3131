...
ACP10AXDBP_typ : STRUCT                                     (* Parameters *)
   datobj_name          : ARRAY [0..11] OF USINT ;          (* Name of the data object *)
   reserve              : UINT ;                            (* Reserved *)
...
ACP10SAFEINDAT_typ : STRUCT                                 (* SafeMC: SafeIN data *)
   ...
   reserved_stat_b26    : USINT ;                           (* reserved_stat_b26 *)
   reserved_stat_b27    : USINT ;                           (* reserved_stat_b27 *)
