...
typedef struct MC_070BR_CheckAutCompensation
{
	/* VAR_INPUT (analog) */
	unsigned long Master;
	unsigned long Slave;
	...
	plcbit Busy;
	plcbit Error;
} MC_070BR_CheckAutCompensation_typ;

typedef struct MC_071BR_TorqueControl
{
	/* VAR_INPUT (analog) */
	unsigned long Axis;
	unsigned short StartParID;
	...
	plcbit DataInitialized;
	plcbit WaitingForStart;
} MC_071BR_TorqueControl_typ;

typedef struct MC_072BR_AxisErrorCollector
{
	/* VAR_INPUT (analog) */
	unsigned long Axis;
	/* VAR_OUTPUT (analog) */
	...
	plcbit AxisWarning;
	plcbit Errorstop;
} MC_072BR_AxisErrorCollector_typ;

typedef struct MC_073BR_ReadAxisError
{
	/* VAR_INPUT (analog) */
	unsigned long Axis;
	unsigned short Mode;
	...
	plcbit Error;
	plcbit ErrorRecordAvailable;
} MC_073BR_ReadAxisError_typ;

typedef struct MC_074BR_DigitalCamSwitch
{
	/* VAR_INPUT (analog) */
	struct MC_MASTER_SWITCHES_REF Switches;
	struct MC_OUTPUT_OPTIONS_REF OutputOptions;
	...
	plcbit TrackOptionsInitialized;
	plcbit Value;
} MC_074BR_DigitalCamSwitch_typ;

typedef struct MC_075BR_GetParIDInfo
{
	/* VAR_INPUT (analog) */
	unsigned short ParID;
	/* VAR_OUTPUT (analog) */
	...
	plcbit Busy;
	plcbit Error;
} MC_075BR_GetParIDInfo_typ;

typedef struct MC_076BR_SetHardwareInputs
{
	/* VAR_INPUT (analog) */
	unsigned long Axis;
	/* VAR_OUTPUT (analog) */
	...
	plcbit Error;
	plcbit InputsSet;
} MC_076BR_SetHardwareInputs_typ;

typedef struct MC_077BR_BrakeControl
{
	/* VAR_INPUT (analog) */
	unsigned long Axis;
	unsigned char Command;
	...
	plcbit Error;
	plcbit BrakeStatus;
} MC_077BR_BrakeControl_typ;

typedef struct MC_078BR_InitSendParID
{
	/* VAR_INPUT (analog) */
	unsigned long Axis;
	unsigned short ParID;
	...
	plcbit Busy;
	plcbit Error;
} MC_078BR_InitSendParID_typ;

typedef struct MC_079BR_InitReceiveParID
{
	/* VAR_INPUT (analog) */
	unsigned long Master;
	unsigned long Slave;
	...
	plcbit Busy;
	plcbit Error;
} MC_079BR_InitReceiveParID_typ;

typedef struct MC_080BR_CalcSectionsFromCam
{
	/* VAR_INPUT (analog) */
	plcstring DataObjectName[13];
	unsigned long DataAddress;
	...
	plcbit Busy;
	plcbit Error;
} MC_080BR_CalcSectionsFromCam_typ;

typedef struct MC_081BR_InitReceiveNetworkData
{
	/* VAR_INPUT (analog) */
	unsigned long Axis;
	unsigned char NodeNumber;
	...
	plcbit Busy;
	plcbit Error;
} MC_081BR_InitReceiveNetworkData_typ;

typedef struct MC_082BR_SaveCamProfileObj
{
	/* VAR_INPUT (analog) */
	plcstring DataObjectName[13];
	unsigned long DataAddress;
	...
	plcbit Busy;
	plcbit Error;
} MC_082BR_SaveCamProfileObj_typ;

typedef struct MC_083BR_JogVelocity
{
	/* VAR_INPUT (analog) */
	unsigned long Axis;
	float Velocity;
	...
	plcbit Error;
	plcbit Jogging;
} MC_083BR_JogVelocity_typ;

typedef struct MC_084BR_JogLimitPosition
{
	/* VAR_INPUT (analog) */
	unsigned long Axis;
	float Velocity;
	...
	plcbit Jogging;
	plcbit LimitReached;
} MC_084BR_JogLimitPosition_typ;

typedef struct MC_085BR_JogTargetPosition
{
	/* VAR_INPUT (analog) */
	unsigned long Axis;
	float Velocity;
	...
	plcbit MovingToTarget;
	plcbit TargetReached;
} MC_085BR_JogTargetPosition_typ;

typedef struct MC_086BR_GetParIDTransferInfo
{
	/* VAR_INPUT (analog) */
	unsigned long Axis;
	/* VAR_OUTPUT (analog) */
	...
	plcbit Busy;
	plcbit Error;
} MC_086BR_GetParIDTransferInfo_typ;

typedef struct MC_087BR_GearIn
{
	/* VAR_INPUT (analog) */
	unsigned long Master;
	unsigned long Slave;
...
typedef struct MC_088BR_OffsetVelocity
{
	/* VAR_INPUT (analog) */
	unsigned long Slave;
	float CyclicVelocity;
	...
	plcbit Error;
	plcbit VelocityAttained;
} MC_088BR_OffsetVelocity_typ;

typedef struct MC_089BR_OffsetZone
{
	/* VAR_INPUT (analog) */
	unsigned long Slave;
	float Shift;
	...
	plcbit ShiftAttained;
	plcbit DataInitialized;
} MC_089BR_OffsetZone_typ;

typedef struct MC_090BR_SetupSynchronMotor
{
	/* VAR_INPUT (analog) */
	unsigned long Axis;
	unsigned short Command;
	...
	plcbit CommandAborted;
	plcbit Error;
} MC_090BR_SetupSynchronMotor_typ;

typedef struct MC_091BR_CheckEndlessPosition
{
	/* VAR_INPUT (analog) */
	unsigned long Axis;
	unsigned long DataAddress;
	...
	plcbit EndlessPositionInitialized;
	plcbit DataValid;
} MC_091BR_CheckEndlessPosition_typ;

typedef struct MC_092BR_LimitLoad
{
	/* VAR_INPUT (analog) */
	unsigned long Axis;
	float LoadPosAccel;
	...
	plcbit Error;
	plcbit DataInitialized;
} MC_092BR_LimitLoad_typ;

typedef struct MC_093BR_LimitLoadCam
{
	/* VAR_INPUT (analog) */
	unsigned long Axis;
	unsigned short CamProfileIndexPos;
	...
	plcbit Error;
	plcbit DataInitialized;
} MC_093BR_LimitLoadCam_typ;

typedef struct MC_095BR_ConfigPowerStageCheck
{
	/* VAR_INPUT (analog) */
	unsigned long Axis;
	struct MC_POWER_STAGE_CHECK_REF Configuration;
	...
	plcbit Busy;
	plcbit Error;
} MC_095BR_ConfigPowerStageCheck_typ;

typedef struct MC_094BR_ResetAutPar
{
	/* VAR_INPUT (analog) */
	unsigned long Axis;
	unsigned char GlobalParams;
...
void MC_070BR_CheckAutCompensation(struct MC_070BR_CheckAutCompensation* inst);
void MC_071BR_TorqueControl(struct MC_071BR_TorqueControl* inst);
void MC_072BR_AxisErrorCollector(struct MC_072BR_AxisErrorCollector* inst);
void MC_073BR_ReadAxisError(struct MC_073BR_ReadAxisError* inst);
void MC_074BR_DigitalCamSwitch(struct MC_074BR_DigitalCamSwitch* inst);
void MC_075BR_GetParIDInfo(struct MC_075BR_GetParIDInfo* inst);
void MC_076BR_SetHardwareInputs(struct MC_076BR_SetHardwareInputs* inst);
void MC_077BR_BrakeControl(struct MC_077BR_BrakeControl* inst);
void MC_078BR_InitSendParID(struct MC_078BR_InitSendParID* inst);
void MC_079BR_InitReceiveParID(struct MC_079BR_InitReceiveParID* inst);
void MC_080BR_CalcSectionsFromCam(struct MC_080BR_CalcSectionsFromCam* inst);
void MC_081BR_InitReceiveNetworkData(struct MC_081BR_InitReceiveNetworkData* inst);
void MC_082BR_SaveCamProfileObj(struct MC_082BR_SaveCamProfileObj* inst);
void MC_083BR_JogVelocity(struct MC_083BR_JogVelocity* inst);
void MC_084BR_JogLimitPosition(struct MC_084BR_JogLimitPosition* inst);
void MC_085BR_JogTargetPosition(struct MC_085BR_JogTargetPosition* inst);
void MC_086BR_GetParIDTransferInfo(struct MC_086BR_GetParIDTransferInfo* inst);
void MC_087BR_GearIn(struct MC_087BR_GearIn* inst);
void MC_088BR_OffsetVelocity(struct MC_088BR_OffsetVelocity* inst);
void MC_089BR_OffsetZone(struct MC_089BR_OffsetZone* inst);
void MC_090BR_SetupSynchronMotor(struct MC_090BR_SetupSynchronMotor* inst);
void MC_091BR_CheckEndlessPosition(struct MC_091BR_CheckEndlessPosition* inst);
void MC_092BR_LimitLoad(struct MC_092BR_LimitLoad* inst);
